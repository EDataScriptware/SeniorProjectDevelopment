...
<div class = "buttonScrollView">
	<button id = "aboutBut" class = "scrollItem scrollActive" onClick ="showAbout()"> <i class="fa fa-file fa-lg"></i> <br> About</button>
	<button id = "schBut" class = "scrollItem"  onClick ="showRes()"> <i class="fa fa-file fa-lg"></i>  <br> Schedule</button>
	<?php if (in_array($_SESSION["userPerm"], $allowed)) { ?><button id = "medBut" class = "scrollItem" onClick ="showMed()"> <i class="fa fa-file fa-lg"></i>  <br>Medical Info</button><?php } ?>
	<?php if (in_array($_SESSION["userPerm"], $allowed)) { ?><button id = "hisBut" class = "scrollItem" onClick ="showAcc()"> <i class="fa fa-file fa-lg"></i>  <br>History</button> <?php } ?>
