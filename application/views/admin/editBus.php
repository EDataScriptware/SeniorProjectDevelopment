...
<?php if(isset($bus_data) && isset($team_data)) { ?>
    ...
    <div style="display: inline;">
      ...
      <button type="button" class="btn btn-danger" onclick="location.href='<?php echo base_url('Admin/deleteBus/'.$bus_data->bus_id) ;?>'" id="deleteBus">Delete Bus</button>
    </div>
    <br/>
    <br/>
        ...
        <tbody>
            <?php foreach($team_data as $team) { ?>
                <tr>
                    ...
                    <td><button type="button" class="btn btn-danger" onclick="location.href='<?php echo base_url('Admin/deleteTeam/'.$team->team_id.'/'.$bus_data->bus_id) ;?>'">Delete</button></td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
        ...
        Team Leader: <input list="leader_id" name='leader_id'>
                        <datalist id="leader_id">
                            <?php foreach($leader_data as $leader) { ?>
                                <option value="<?php echo $leader->guardian_id; ?>"><?php echo $leader->last_name . ', ' . $leader->first_name ; ?></option>
                            <?php } ?>
                        </datalist>
        <br/>
