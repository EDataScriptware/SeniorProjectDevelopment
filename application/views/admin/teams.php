...
<br>  
<h3> Team <?php echo $tem->color ?> Veterans <button type="button" class="btn btn-primary" onclick = "moveTeam(<?php echo $tem->tem_id ?>)"  > MOVE </button> <button type="button" class="btn btn-primary" onclick = "removeTeam(<?php echo $tem->tem_id ?>)"  > REMOVE </button> </h3>
