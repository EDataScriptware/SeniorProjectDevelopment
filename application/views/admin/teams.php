...
<table id="<?php echo $tem->color ?>Vet"  class="table table-striped table-bordered">
	...
	?>
        ...
        <tr>
            ...
            <td> <?php if ($guardian[0] != null) { echo  $guardian[0]->first_name." ".$guardian[0]->last_name } 
            else {echo "None"}?></td>
            <td> <?php if ($guardian[0] != null) { echo  'Day_Phone: '.$guardian[0]->day_phone.'<br> Cell_Phone: '.$guardian[0]->cell_phone } 
            else {echo "None"}?> </td>
